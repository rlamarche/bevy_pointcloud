...
use crate::{octree::asset::Octree, pointcloud_octree::render::data::PointCloudOctree3dUniform};
...
impl ExtractComponent for PointCloudOctree3d {
    type QueryData = (&'static PointCloudOctree3d, &'static GlobalTransform);
    type QueryFilter = ();
    type Out = (PointCloudOctree3d, PointCloudOctree3dUniform);
