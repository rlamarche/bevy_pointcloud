...
impl PointCloudOctree3dPhase for PointCloudOctree3dAttributePhase {
    fn node_id(&self) -> NodeId {
        self.bin_key.node_id
    }
}

impl PhaseItem for PointCloudOctree3dAttributePhase {
    #[inline]
...
impl BinnedPhaseItem for PointCloudOctree3dAttributePhase {
    ...
    fn new(
        ...
        PointCloudOctree3dAttributePhase {
            batch_set_key,
            bin_key,
...
impl CachedRenderPipelinePhaseItem for PointCloudOctree3dAttributePhase {
    #[inline]
