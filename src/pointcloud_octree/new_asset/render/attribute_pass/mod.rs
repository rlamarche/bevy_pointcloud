...
use crate::octree::new_asset::extract::{RenderVisibleOctreeNodes, VisibleOctreeNode};
...
use super::super::component::NewPointCloudOctree3d;
...
fn queue_attribute_pass(
    ...
    point_cloud_octrees_3d: Query<&NewPointCloudOctree3d>,
    mut custom_render_phases: ResMut<ViewBinnedRenderPhases<PointCloudOctree3dAttributePhase>>,
    mut views: Query<(&ExtractedView, &RenderVisibleOctreeNodes<PointCloudNodeData, NewPointCloudOctree3d>, &Msaa)>,
